...
def generate_llm_response(user_input):
    location = "hackmit"
    nameOfPerson = "Rishita Dhalbisoi"
    messages = [
        {"role": "system", "content": "You are an app who is calling Spiderman to save someone. Answer questions or generate a reply like \"On my way in 15\""},
        {"role": "user", "content": user_input + " location is " + str(location) + " name is " + str(nameOfPerson)},
    ]
